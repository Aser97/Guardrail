...
#
# Usage:
#   bash scripts/run_2abcd.sh                # full run  (~80 rows per augmentation type)
#   bash scripts/run_2abcd.sh --test         # test run  (2 per type, verbose)
#   bash scripts/run_2abcd.sh --append       # resume    (proportional skip of existing rows)
#   bash scripts/run_2abcd.sh --test --append
#
# Env vars required:
