...
from config import SIGNALS, SIGNAL_DESCRIPTIONS, HACKATHON_MODELS, TEMPERATURE
...
MISTRAL = HACKATHON_MODELS["mistral"]
COMMAND = HACKATHON_MODELS["command"]
...
_OPERATOR_MODEL = {
    "deepen":     MISTRAL,
    "diversify":  GPT_OSS,  # COMMAND excluded (504 timeouts)
    "complicate": MISTRAL,
}
