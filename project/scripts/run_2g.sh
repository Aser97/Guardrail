...
#
# Usage:
#   bash scripts/run_2g.sh                # full run  (200 conversations)
#   bash scripts/run_2g.sh --test         # test run  (4 conversations, verbose)
#   bash scripts/run_2g.sh --append       # resume    (reduces targets by already-written rows)
#   bash scripts/run_2g.sh --test --append
#
# Env vars required:
